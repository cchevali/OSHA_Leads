> DEPRECATED - see `docs/V1_CUSTOMER_VALIDATED.md`, `docs/DECISIONS.md`, and `docs/RUNBOOK.md`.
> Date: 2026-02-12
...
**Current Status:** âœ… MVP Complete | ðŸ”„ Pending Production Identity Setup
...
| One-Click unsubscribe | ðŸ”„ | Conditional on UNSUB_ENDPOINT_BASE |
