...
class TestDigestPriorityPipeline(unittest.TestCase):
    def test_zero_state_coverage_renders_explicit_zero(self):
        ...
        self.assertIn("Most important today", html)
        self.assertIn("Most important today", text)
        self.assertIn("Most activity is in CA and WA", html)
        self.assertIn("Most activity is in CA and WA", text)
