...
WRAPPER = REPO_ROOT / "scripts" / "scheduled" / "run_trial_roi_safety_daily.ps1"


class TestRunTrialRoiSafetyDailyWrapper(unittest.TestCase):
    def test_wrapper_exists_and_has_required_tokens(self):
        ...
        self.assertIn("roi_safety_trial", text)
