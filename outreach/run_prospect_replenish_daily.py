...
DEFAULT_AUTOGROW_SOURCES = ",".join(source_policy.CONSULTANT_PRIMARY_SOURCES) or "AIHA"
...
def build_parser() -> argparse.ArgumentParser:
    ap = argparse.ArgumentParser(
        description="Run deterministic daily prospect replenishment pipeline: doctor -> generation -> discovery."
    )
