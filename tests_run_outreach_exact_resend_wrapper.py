...
SCRIPT = REPO_ROOT / "run_outreach_exact_resend.py"


class TestRunOutreachExactResendWrapper(unittest.TestCase):
    def test_help_lists_required_flags(self):
        ...
        self.assertIn("--source-batches", out)
    ...
    def test_wrapper_is_thin_shim(self):
        ...
        self.assertIn("from outreach.run_outreach_exact_resend import main", text)
